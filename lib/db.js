...
async function openDatabase() {
    return new Promise((resolve, reject) => {
        ...
        request.onsuccess = () => {
            console.log('[DB] IndexedDB ouverte avec succès');
            resolve(request.result);
        };

        request.onupgradeneeded = (event) => {
            console.log('[DB] Création/Mise à jour du store...');
            ...
            if (!db.objectStoreNames.contains(STORE_NAME)) {
                ...
                console.log('[DB] Store "payloads" créé');
            }
        };
    });
}
    ...
    async savePayload(id, type, content) {
        try {
            ...
            return new Promise((resolve, reject) => {
                ...
                request.onsuccess = () => {
                    console.log(`[DB] Payload sauvegardé: ${id}`);
                    resolve();
                };
            });
        } catch (error) {
        ...
        try {
            ...
            return new Promise((resolve, reject) => {
                ...
                request.onsuccess = () => {
                    ...
                    console.log(`[DB] getPayload(${id}):`, result ? 'trouvé' : 'non trouvé');
                    resolve(result);
                };
            });
        } catch (error) {
    ...
    async deletePayload(id) {
        try {
            ...
            return new Promise((resolve, reject) => {
                ...
                request.onsuccess = () => {
                    console.log(`[DB] Payload supprimé: ${id}`);
                    resolve();
                };
            });
        } catch (error) {
